...
The code of this game is well commented and flexible being as **Starter Kit** or Tutorial. You can implement AI even for cat, add team of cats, bonuses, tweak input features to make mouse move stepwise or adding walls inside the grid to make it as maze.
